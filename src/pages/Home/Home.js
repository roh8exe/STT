...
const Home = () => {
  ...
  const handleGenerateSpeech = async () => {
    ...
    try {
      // Pass source language if it's not set to 'auto'
  ...
  const switchModel = (model) => {
    ...
    // Smooth scroll to the model container
    if (modelContainerRef.current) {
      modelContainerRef.current.scrollIntoView({ 
        behavior: 'smooth', 
        block: 'start'
      });
    }
  ...
  return (
    <div className="home-page">
      ...
      <section className="models-section">
        <div className="model-selector-container scroll-trigger">
        ...
        <div className="model-container scroll-trigger" ref={modelContainerRef}>
          ...
          {activeModel === 'text-to-speech' && (
            <div className="text-to-speech-container">
              <div className="step-indicator">
                ...
                <div className={`step ${inputText && (sourceLanguage !== 'auto' || targetLanguage !== 'en') ? 'active' : ''}`}>
                  <div className="step-number">2</div>
                  <div className="step-text">Choose Languages</div>
                </div>
                <div className={`step-divider ${inputText && (sourceLanguage !== 'auto' || targetLanguage !== 'en') ? 'active' : ''}`}></div>
              ...
              <div className="language-options">
                <div className="language-selection">
                  ...
                  <LanguageSelector
                    ...
                    includeAuto={true}
                  />
                  <small className="helper-text">The language you're writing in</small>
                </div>
                <div className="language-divider">
                  <div className="arrow-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="language-selection">
                  ...
                  <LanguageSelector
                    ...
                    includeAuto={false}
                  />
                  <small className="helper-text">The language for the generated speech</small>
                </div>
              </div>
      ...
      <section className="features-section">
        <div className="features-grid scroll-trigger">
